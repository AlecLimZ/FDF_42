...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/12/28 18:48:38 by leng-chu          #+#    #+#             */
/*   Updated: 2021/12/28 18:54:01 by leng-chu         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	key_press(int key, void *param)
{
	...
	if (key == MAIN_PAD_ESC)
		exit(0);
	if (key == NUM_PAD_PLUS || key == MAIN_PAD_PLUS || key == NUM_PAD_MINUS || key == MAIN_PAD_MINUS)
		zoom(key, fdf);
